...
SECRET_KEY = 'django-insecure-5k^cxtz1kh&rhzkn3al@0o=h&(79_i3!@qnt_((bkn83vxnu4-'
...
INSTALLED_APPS = [
    # this instead of registering models to admin. I have to add this prop down to make model migrate 
    # successfully : AUTH_USER_MODEL = 'api.User' 
    'jazzmin',
    ...
    'api',  # Ensure this is correctly named
    'corsheaders',
    'rest_framework',
